...
arriba = pygame.image.load("FB_WU.png").convert_alpha()         
arriba = pygame.transform.scale(arriba,(fbx,fby))                                                       
fbwd = pygame.image.load("FB_WD.png")
fbwd = pygame.transform.scale(fbwd,(fbx,fby))  
fbw = pygame.image.load("FB_W.png")
fbw = pygame.transform.scale(fbw,(fbx,fby))  

birdy = arriba  #Flappy Bird

bot = pygame.image.load("pipe_bot.png").convert_alpha()      
bot = pygame.transform.scale(bot,(fbx*1.3, size_y))   #Tubo de arriba para abajo

top = pygame.image.load("pipe_top.png").convert_alpha()      
...
def juego():
    ...
    frame = 0
    volando = True
    bird = flappy(size_x/5.5, 150, lista)
    birds.add(bird)
    gameover = False
